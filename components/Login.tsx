...
export const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center bg-cover bg-center font-sans overflow-hidden"
         style={{ backgroundImage: 'url("./Imagenes/city.jpg")' }}>
        ...
        <div className="relative z-10 w-full max-w-[440px] bg-white/90 backdrop-blur-xl rounded-[2.5rem] shadow-2xl p-10 mx-4 border border-white/40 flex flex-col items-center">
            ...
            <div className="flex flex-col items-center mb-10 w-full">
                ...
                <p className="text-xs font-bold text-slate-500 uppercase tracking-[0.25em] mt-3">Masterplan AI</p>
            </div>

            {/* Form */}
            <form onSubmit={handleLogin} className="w-full space-y-6">
                <div className="space-y-2 group">
                    <label className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1 group-focus-within:text-blue-600 transition-colors">Usuario</label>
                    <input 
                        type="email" 
                ...
                <div className="space-y-2 group">
                    <label className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1 group-focus-within:text-blue-600 transition-colors">Contraseña</label>
                    <input 
                        type="password" 
            ...
            <div className="mt-10 text-center border-t border-slate-200/50 w-full pt-8">
                <p className="text-[11px] text-slate-400 font-medium leading-relaxed">
                    ...
                    <br/>&copy; 2025 Urban Lytica Technologies
                </p>
            </div>
        </div>
    </div>
